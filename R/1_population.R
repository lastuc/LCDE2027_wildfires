...
pop23_raster<- deepcopy(popempty); time(pop23_raster, tstep="years") <- 2023
pop24_raster<- deepcopy(popempty); time(pop24_raster, tstep="years") <- 2024
pop25_raster<- deepcopy(popempty); time(pop25_raster, tstep="years") <- 2025
...
popall <- c(pop03_raster,pop04_raster,pop05_raster,
            ...
            pop18_raster,
            pop19_raster,pop20_raster,
            pop21_raster,
            pop22_raster,pop23_raster,pop24_raster,pop25_raster)
